...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string courseno = crsnoComboBox.Text;
            CAP1.setcoursno(courseno);
            ...
            // passes the value of radio button to the variable depending on which one is selected.
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet.crsno' table. You can move, or remove it, as needed.
            this.crsnoTableAdapter.Fill(this.database1DataSet.crsno);
